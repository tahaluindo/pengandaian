                                    ...
                                    <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($get_all as $data) {
                                                ...
                                                $detail = '<a href="#" id="detailDeposito" class="btn btn-sm btn-info" title="Detail Data" data-toggle="modal" data-target="#detailModal" data-name="' . $data->name . '" data-nik="' . $data->nik . '" data-address="' . $data->address . '" data-email="' . $data->email . '" data-phone="' . $data->phone . '" data-total_deposito="' . $data->total_deposito . '" data-jangka_waktu="' . $data->jangka_waktu . '" data-waktu_deposito="' . $data->waktu_deposito . '" data-jatuh_tempo="' . $data->jatuh_tempo . '" data-bagi_hasil="' . $data->bagi_hasil . '"><i class="fas fa-info-circle"></i></a>';
                                            ?>
                                                <tr>
